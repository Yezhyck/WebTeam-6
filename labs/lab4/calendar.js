var _Calendar=function(){
    ...
    cs_out:function(e){
        _Calendar.evtTgt(e).style.background='#f5deb3';
    },
    ...
    prepcalendar:function( hd, cm, cy ){
        ...
        for(var y=cy+_Calendar.YearFrom;y<=cy+_Calendar.YearTo;y++)   d=d+'<option value="'+y+'"'+(y==cy?' selected':'')+'>'+y+'</option>'; 
        _Calendar.$('Calendar_mns').innerHTML=' <select onChange="_Calendar.cmonth(this);">' + vd + '</select><select onChange="_Calendar.cyear(this);">' + d + '</select>'; 
    ...
    _Calendar.ccy=n.getFullYear();
        ...
        s+="\n"+'<tr style="background:#191970;font:12px Arial;color:#f5deb3"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>';
