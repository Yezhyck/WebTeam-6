function pushParticipantsPhotos() {
    ...
    fill.innerHTML = '<br><img src="n.jpg" alt="Кошова А." style="width: 250px; height: 250px; margin: 5px;"><br>Кошова Анастасія<br><br>' +
        '<img src="y.jpg" alt="Глушко Ю." style="width: 250px; height: 250px; margin: 5px;"><br>Глушко Юлія<br><br>' +
        '<img src="s.jpg" alt="Яцук С." style="width: 250px; height: 250px; margin: 5px;"><br>Яцук Сергій';
}
...
function pushSelectors() {
    ...
    example.innerHTML = '<br><b>Приклади.</b><br><br><img src="/lab2/classes.png" alt=""><br>Рис. 5, назви класів(ЛР-2).<br><br><img src="/lab2/sel1.png" alt=""><br>Рис. 6, селектор класу "btn_show"(ЛР-2).<br><br><img src="/lab2/sel2.png" alt=""><br>Рис. 7, cелектор класу "btn_show_small"(ЛР-2).<br><br><img src="/lab2/sel3.png" alt=""><br>Рис. 8, cелектори класів "dropdown" та "dropdown-content"(ЛР-2).<br><br><img src="/lab2/hf.png" alt=""><br>Рис. 9, класи "head" та "fill"(ЛР-2).<br><br><img src="/lab2/hf_s.png" alt=""><br>Рис. 10, cелектор1 = тег &lt;div&gt; + клас "head"<br>cелектор2 = тег &lt;div&gt; + клас "fill"(ЛР-2).<br><br><img src="/lab2/a_tag.png" alt=""><br>Рис. 11, &lt;a&gt; теги(ЛР-2).<br><br><img src="/lab2/a_sel.png" alt=""><br>Рис. 12, селетрор тегу &lt;a&gt;(ЛР-2).';
}
...
function pushOtherSelectors() {
    ...
    example.innerHTML = '<br><b>Приклади.</b><br><br><img src="/lab2/hfe.png" alt=""><br>Рис. 13, ідентифікатори "head", "fill" та "example"(ЛР-2).<br><br><img src="/lab2/hfes.png" alt=""><br>Рис. 14, селектор ідентифікатора(ЛР-2).<br><br><img src="/lab2/hfes1.png" alt=""><br>Рис. 15, теги &lt;div&gt; та (ідентифікатори "head", "fill" та "example")(ЛР-2).<br><br><img src="/lab2/dhfes.png" alt=""><br>Рис. 16, селектор1 = тег &lt;div&gt; + ідентифікатор "head"<br>селектор2 = тег &lt;div&gt; + ідентифікатор "fill"<br>селектор3 = тег &lt;div&gt; + ідентифікатор "example"<br>(ЛР-2).<br><br><img src="/lab2/fb.png" alt=""><br>Рис. 17, тег &lt;form&gt; та &lt;button&gt;(ЛР-2).<br><br><img src="/lab2/fb_s.png" alt=""><br>Рис. 18, контекстний селектор = тег &lt;form&gt; + &lt;button&gt;(ЛР-2).<br><br><img src="/lab2/bdda.png" alt=""><br>Рис. 19, теги &lt;body&gt;, &lt;div&gt;, &lt;div&gt; та &lt;a&gt;(ЛР-2).<br><br><img src="/lab2/arr.png" alt=""><br>Рис. 20, дочірні селектори(ЛР-2).<br><br><img src="/lab2/p.png" alt=""><br>Рис. 21, клас "btn_show" та сусідній тег &lt;div&gt;(ЛР-2).<br><br><img src="/lab2/ps.png" alt=""><br>Рис. 22, комбінаційний селектор клас "btn_show" + сусідній тег &lt;div&gt;(ЛР-2).<br>';
}
...
function pushGroupSelectors() {
    ...
    example.innerHTML = '<br><b>Приклади.</b><br><br><img src="/lab2/bdda.png" alt=""><br>Рис. 19, теги &lt;body&gt;, &lt;div&gt;, &lt;div&gt; та &lt;a&gt;(ЛР-2).<br></br><br><img src="/lab2/bddas.png" alt=""><br>Рис. 20, ланйцюжковий селектор з тегів &lt;body&gt;, &lt;div&gt;, &lt;div&gt; та &lt;a&gt(ЛР-2).</br>';
}
...
function pushIden() {
    ...
    example.innerHTML = '<br><br><b>Приклади.</b><br><br><img src="/lab2/iden.png" alt=""><br>Рис. 1, ідентифікатори(ЛР-2).<br><br><img src="/lab2/idens.png" alt=""><br>Рис. 2, звернення до ідентивікаторів, що виділені маркерами, в CSS-файлі(ЛР-2).<br>';
}
...
function pushIndentation() {
    ...
    example.innerHTML = '<br><br><b>Приклади.</b><br><br><img src="/lab2/ent.png" alt=""><br>Рис. 3, CSS-стилі внутрішніх та зовнішніх відступів "padding", "marging-top", "marging-left", "marging-right" відповідно(ЛР-2).';
}
...
function pushFloatElements() {
    ...
    var fill;
    var float_element;
    float_element = '<div id="float_element" class="float_element"><b>Приклад.</b><br><br><img src="/lab2/8.png" alt=""><br>Рис. 4, плаваючий елемент<br> у вигляді картинки, <br>яку "обтікає" текст(ЛР-2).<br></div>';
    header = document.getElementById("head");
    fill = document.getElementById("fill");
